...
Information theoretic approaches do not use p-values. They work on a 'weight of evidence' approach. Here's a quick explainer about why NOT to look at the p-values!  
...
So when there is a 1 in the interaction column, that means the model is predicting 
# Useful references  
